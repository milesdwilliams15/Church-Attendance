...
## Some Models
at<-lm(attendanceNum~white+black+Hispanic+other+as.factor(Income)+as.factor(education)+as.factor(age)+as.factor(married)+as.factor(guidance)+as.factor(ideology)+as.factor(serve)+as.factor(literal)+as.factor(scripture)+as.factor(exclusive)+as.factor(personalGod)+as.factor(certainty)+as.factor(importance),data=relig,weights = WEIGHT)
sd<-lm(as.numeric(studyGroupNum)~white+black+Hispanic+other+as.factor(Income)+as.factor(education)+as.factor(age)+as.factor(married)+as.factor(guidance)+as.factor(ideology)+as.factor(serve)+as.factor(literal)+as.factor(scripture)+as.factor(exclusive)+as.factor(personalGod)+as.factor(certainty)+as.factor(importance),data=relig,weights = WEIGHT)
